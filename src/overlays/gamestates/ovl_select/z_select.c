...
static SceneSelectEntry sScenes[] = {
    ...
    { " 2:SPOT01 (Kakariko Village)", MapSelect_LoadGame, ENTR_SPOT01_0 },
    // "3: SPOT02" (Graveyard)
    { " 3:SPOT02 (Graveyard)", MapSelect_LoadGame, ENTR_SPOT02_0 },
    // "4: SPOT03" (Zora's River)
    { " 4:SPOT03 (Zora's River)", MapSelect_LoadGame, ENTR_SPOT03_0 },
    // "5: SPOT04" (Kokiri Forest)
    { " 5:SPOT04 (Kokiri Forest)", MapSelect_LoadGame, ENTR_SPOT04_0 },
    // "6: SPOT05" (Sacred Forest Meadow)
    { " 6:SPOT05 (Sacred Forest Meadow)", MapSelect_LoadGame, ENTR_SPOT05_0 },
    // "7: SPOT06" (Lake Hylia)
    { " 7:SPOT06 (Lake Hylia)", MapSelect_LoadGame, ENTR_SPOT06_0 },
    // "8: SPOT07" (Zora's Domain)
    { " 8:SPOT07 (Zora's Domain)", MapSelect_LoadGame, ENTR_SPOT07_0 },
    // "9: SPOT08" (Zora's Fountain)
    { " 9:SPOT08 (Zora's Fountain)", MapSelect_LoadGame, ENTR_SPOT08_0 },
    // "10: SPOT09" (Gerudo Valley)
    { "10:SPOT09 (Gerudo Valley)", MapSelect_LoadGame, ENTR_SPOT09_0 },
    // "11: SPOT10" (Lost Woods)
    { "11:SPOT10 (Lost Woods)", MapSelect_LoadGame, ENTR_SPOT10_0 },
    // "12: SPOT11" (Desert Colossus)
    { "12:SPOT11 (Desert Colossus)", MapSelect_LoadGame, ENTR_SPOT11_0 },
    // "13: SPOT12" (Gerudo's Fortress)
    { "13:SPOT12 (Gerudo's Fortress)", MapSelect_LoadGame, ENTR_SPOT12_0 },
    // "14: SPOT13" (Haunted Wasteland)
    { "14:SPOT13 (Haunted Wasteland)", MapSelect_LoadGame, ENTR_SPOT13_0 },
    // "15: SPOT15" (Hyrule Castle)
    { "15:SPOT15 (Hyrule Castle)", MapSelect_LoadGame, ENTR_SPOT15_0 },
    // "16: SPOT16" (Death Mountain Trail)
    { "16:SPOT16 (Death Mountain Trail)", MapSelect_LoadGame, ENTR_SPOT16_0 },
    // "17: SPOT17" (Death Mountain Crater)
    { "17:SPOT17 (Death Mountain Crater)", MapSelect_LoadGame, ENTR_SPOT17_0 },
    // "18: SPOT18" (Goron City)
    { "18:SPOT18 (Goron City)", MapSelect_LoadGame, ENTR_SPOT18_0 },
    // "19: SPOT20" (Lon Lon Ranch)
    { "19:SPOT20 Lon Lon Ranch", MapSelect_LoadGame, ENTR_SPOT20_0 },
    // "20: Chamber of Time" (Temple Of Time)
    { "20: Temple of Time", MapSelect_LoadGame, ENTR_TOKINOMA_0 },
    // "21: Chamber of the Sages" (Chamber of the Sages)
    { "21: Chamber of the Sages", MapSelect_LoadGame, ENTR_KENJYANOMA_0 },
    // "22: Target Range" (Shooting Gallery)
    { "22: Shooting Gallery", MapSelect_LoadGame, ENTR_SYATEKIJYOU_0 },
    // "23: Hyrule Garden Game" (Hyrule Garden Minigame)
    { "23: Hyrule Garden Minigame", MapSelect_LoadGame, ENTR_HAIRAL_NIWA_0 },
    // "24: Grave Dive Hole" (Grave (Redead))
    { "24: Grave (Redead)", MapSelect_LoadGame, ENTR_HAKAANA_0 },
    // "25: Grave Dive Hole 2" (Grave (Fairy's Fountain))
    { "25: Grave (Fairy's Fountain)", MapSelect_LoadGame, ENTR_HAKAANA2_0 },
    // "26: Royal Family's Grave" (Royal Family's Tomb)
    { "26: Royal Family's Tomb", MapSelect_LoadGame, ENTR_HAKAANA_OUKE_0 },
    // "27: Great Fairy's Fountain" (Great Fairy's Fountain (Upgrades))
    { "27: Great Fairy's Fountain (Upgrades)", MapSelect_LoadGame, ENTR_DAIYOUSEI_IZUMI_0 },
    // "28: Fairy Dive Hole" (Fairy's Fountain (Healing Fairies))
    { "28: Fairy's Fountain (Healing Fairies)", MapSelect_LoadGame, ENTR_YOUSEI_IZUMI_TATE_0 },
    // "29: Magic Stone Fairy's Fountain" (Great Fairy's Fountain (Spells))
    { "29: Great Fairy's Fountain (Spells)", MapSelect_LoadGame, ENTR_YOUSEI_IZUMI_YOKO_0 },
    // "30: Final Battle With Ganon" (Battle With Ganon)
    { "30: Battle With Ganon", MapSelect_LoadGame, ENTR_GANON_FINAL_0 },
    // "31: Hyrule Inner Garden" (Castle Courtyard)
    { "31: Castle Courtyard", MapSelect_LoadGame, ENTR_NAKANIWA_0 },
    // "32: Fishing" (Fishing Pond)
    { "32: Fishing Pond", MapSelect_LoadGame, ENTR_TURIBORI_0 },
    // "33: Bombchu Bowling" (Bombchu Bowling Alley)
    { "33: Bombchu Bowling Alley", MapSelect_LoadGame, ENTR_BOWLING_0 },
    // "34: Lon Lon Ranch - Storehouse 1" (Talon's House)
    { "34: Lon Lon Ranch - Talon's House", MapSelect_LoadGame, ENTR_SOUKO_0 },
    // "35: Lon Lon Ranch - Storehouse 2" (Ranch Silo)
    { "35: Lon Lon Ranch - Ranch Silo", MapSelect_LoadGame, ENTR_SOUKO_1 },
    // "36: Lookout Hut" (Guard House)
    { "36: Guard House", MapSelect_LoadGame, ENTR_MIHARIGOYA_0 },
    // "37: Magic Potion Shop" (Granny's Potion Shop)
    { "37: Granny's Potion Shop", MapSelect_LoadGame, ENTR_MAHOUYA_0 },
    // "38: Treasure Chest Shop" (Treasure Chest Game)
    { "38: Treasure Chest Game", MapSelect_LoadGame, ENTR_TAKARAYA_0 },
    // "39: Gold Skulltula House" (House of Skulltula)
    { "39: House of Skulltula", MapSelect_LoadGame, ENTR_KINSUTA_0 },
    // "40: Castle Town - Entrance" (Market Entrance)
    { "40: Castle Town - Market Entrance", MapSelect_LoadGame, ENTR_ENTRA_0 },
    // "41: Castle Town" (Market)
    { "41: Castle Town - Market", MapSelect_LoadGame, ENTR_MARKET_DAY_0 },
    // "42: Back Alley" (Back Alley)
    { "42: Castle Town - Back Alley", MapSelect_LoadGame, ENTR_MARKET_ALLEY_0 },
    // "43: In Front of the Temple of Time" (Temple of Time Exterior)
    { "43: Temple of Time Exterior", MapSelect_LoadGame, ENTR_SHRINE_0 },
    // "44: Link's House" (Link's House)
    { "44: Link's House", MapSelect_LoadGame, ENTR_LINK_HOME_0 },
    // "45: Kakariko Village Row House" (Carpenter Boss's House)
    { "45: Carpenter Boss's House", MapSelect_LoadGame, ENTR_KAKARIKO_0 },
    // "46: Back Alley House" (Back Alley House (Man in Green))
    { "46: Back Alley House (Man in Green)", MapSelect_LoadGame, ENTR_KAKARIKO3_0 },
    // "47: Kokiri Village - Know-It-All Brothers' House" (Know-It-All Brothers' House)
    { "47: Kokiri Village - Know-It-All Brothers' House", MapSelect_LoadGame, ENTR_KOKIRI_HOME_0 },
    // "48: Kokiri Village - Twins' House" (Twins' House)
    { "48: Kokiri Village - Twins' House", MapSelect_LoadGame, ENTR_KOKIRI_HOME3_0 },
    // "49: Kokiri Village - Mido's House" (Mido's House)
    { "49: Kokiri Village - Mido's House", MapSelect_LoadGame, ENTR_KOKIRI_HOME4_0 },
    // "50: Kokiri Village - Saria's House" (Saria's House)
    { "50: Kokiri Village - Saria's House", MapSelect_LoadGame, ENTR_KOKIRI_HOME5_0 },
    // "51: Stable" (Stable)
    { "51: Stable", MapSelect_LoadGame, ENTR_MALON_STABLE_0 },
    // "52: Grave Keeper's House" (Gravekeeper's Hut)
    { "52: Gravekeeper's Hut", MapSelect_LoadGame, ENTR_HUT_0 },
    // "53: Back Alley - Dog Lady's House" (Back Alley House)
    { "53: Back Alley - Dog Lady's House", MapSelect_LoadGame, ENTR_IMPA_0 },
    // "54: Kakariko Village - Impa's House" (Impa's House)
    { "54: Kakariko Village - Impa's House", MapSelect_LoadGame, ENTR_LABO_0 },
    // "55: Hylia Laboratory" (Lakeside Laboratory)
    { "55: Lakeside Laboratory", MapSelect_LoadGame, ENTR_HYLIA_LABO_0 },
    // "56: Tent" (Carpenters' Tent)
    { "56: Carpenters' Tent", MapSelect_LoadGame, ENTR_TENT_0 },
    // "57: Shield Shop" (Bazaar)
    { "57: Bazaar", MapSelect_LoadGame, ENTR_SHOP1_0 },
    // "58: Kokiri Shop" (Kokiri Shop)
    { "58: Kokiri Shop", MapSelect_LoadGame, ENTR_KOKIRI_SHOP_0 },
    // "59: Goron Shop" (Goron Shop)
    { "59: Goron Shop", MapSelect_LoadGame, ENTR_GOLON_0 },
    // "60: Zora Shop" (Zora Shop)
    { "60: Zora Shop", MapSelect_LoadGame, ENTR_ZOORA_0 },
    // "61: Kakariko Village - Potion Shop" (Kakariko Potion Shop)
    { "61: Kakariko Village - Potion Shop", MapSelect_LoadGame, ENTR_DRAG_0 },
    // "62: Castle Town - Potion Shop" (Market Potion Shop)
    { "62: Castle Town - Potion Shop", MapSelect_LoadGame, ENTR_ALLEY_SHOP_0 },
    // "63: Back Alley - Night Shop" (Bombchu Shop)
    { "63: Back Alley - Bombchu Shop", MapSelect_LoadGame, ENTR_NIGHT_SHOP_0 },
    // "64: Mask Shop" (Happy Mask Shop)
    { "64: Happy Mask Shop", MapSelect_LoadGame, ENTR_FACE_SHOP_0 },
    // "65: Gerudo Training Area" (Gerudo Training Ground)
    { "65: Gerudo Training Ground", MapSelect_LoadGame, ENTR_MEN_0 },
    // "66: Fairy Tree Dungeon" (Inside the Deku Tree)
    { "66: Deku Tree Dungeon - Inside the Deku Tree", MapSelect_LoadGame, ENTR_YDAN_0 },
    // "67: Fairy Tree Dungeon - Boss" (Gohma's Lair)
    { "67: DT Dungeon - Gohma's Lair", MapSelect_LoadGame, ENTR_YDAN_BOSS_0 },
    // "68: Dondogo Dungeon" (Dodongo's Cavern)
    { "68: Dodongo Dungeon - Dodongo's Cavern", MapSelect_LoadGame, ENTR_DDAN_0 },
    // "69: Dondogo Dungeon - Boss" (King Dodongo's Lair)
    { "69: Dodongo Dungeon - King Dodongo's Lair", MapSelect_LoadGame, ENTR_DDAN_BOSS_0 },
    // "70: Giant Fish Dungeon" (Inside Jabu-Jabu's Belly)
    { "70: Inside Jabu-Jabu's Belly", MapSelect_LoadGame, ENTR_BDAN_0 },
    // "71: Giant Fish Dungeon - Boss" (Barinade's Lair)
    { "71: IJJB - Barinade's Lair", MapSelect_LoadGame, ENTR_BDAN_BOSS_0 },
    // "72: Forest Temple" (Forest Temple)
    { "72: Forest Temple", MapSelect_LoadGame, ENTR_BMORI1_0 },
    // "73: Forest Temple - Boss" (Phantom Ganon's Lair)
    { "73: FT - Phantom Ganon's Lair", MapSelect_LoadGame, ENTR_MORIBOSSROOM_0 },
    // "74: Dungeon Below the Well" (Bottom of the Well)
    { "74: Bottom of the Well", MapSelect_LoadGame, ENTR_HAKADANCH_0 },
    // "75: Dungeon Beneath the Graves" (Shadow Temple)
    { "75: Shadow Temple", MapSelect_LoadGame, ENTR_HAKADAN_0 },
    // "76: Dungeon Beneath the Graves - Boss" (Bongo Bongo's Lair)
    { "76: ST - Bongo Bongo's Lair", MapSelect_LoadGame, ENTR_HAKADAN_BS_0 },
    // "77: Fire Temple" (Fire Temple)
    { "77: Fire Temple", MapSelect_LoadGame, ENTR_HIDAN_0 },
    // "78: Fire Temple - Boss" (Volvagia's Lair)
    { "78: FT - Volvagia's Lair", MapSelect_LoadGame, ENTR_FIRE_BS_0 },
    // "79: Water Temple" (Water Temple)
    { "79: Water Temple", MapSelect_LoadGame, ENTR_MIZUSIN_0 },
    // "80: Water Temple - Boss" (Morpha's Lair)
    { "80: WT - Morpha's Lair", MapSelect_LoadGame, ENTR_MIZUSIN_BS_0 },
    // "81: Evil Goddess Statue Dungeon" (Spirit Temple)
    { "81: Spirit Temple", MapSelect_LoadGame, ENTR_JYASINZOU_0 },
    // "82: Evil Goddess Statue Dungeon - Iron Knuckle" (Iron Knuckle's Lair)
    { "82: ST - Iron Knuckle's Lair", MapSelect_LoadGame, ENTR_JYASINBOSS_0 },
    // "83: Evil Goddess Statue Dungeon - Boss" (Twinrova's Lair)
    { "83: ST - Twinrova's Lair", MapSelect_LoadGame, ENTR_JYASINBOSS_2 },
    // "84: Ganon's Tower" (Ganon's Tower)
    { "84: Ganon's Tower", MapSelect_LoadGame, ENTR_GANON_0 },
    // "85: Ganon's Tower - Boss" (Ganondorf's Lair)
    { "85: GT - Ganondorf's Lair", MapSelect_LoadGame, ENTR_GANON_BOSS_0 },
    // "86: Ice Cavern" (Ice Cavern)
    { "86: Ice Cavern", MapSelect_LoadGame, ENTR_ICE_DOUKUTO_0 },
    // "87: Relay Beneath the Graves" (Dampé's Grave)
    { "87: Dampé's Grave", MapSelect_LoadGame, ENTR_HAKASITARELAY_0 },
    // "88: Ganon's Basement Dungeon" (Inside Ganon's Castle)
    { "88: Inside Ganon's Castle", MapSelect_LoadGame, ENTR_GANONTIKA_0 },
    // "89: Final Battle With Ganon - Cutscene & Battle" (Ganondorf's Death Scene & Tower Escape Exterior)
    { "89: Ganondorf's Death Scene & Tower Escape Exterior", MapSelect_LoadGame, ENTR_GANON_DEMO_0 },
    // "90: Ganon's Tower Aftermath 1" (Escaping Ganon's Tower 1)
    { "90: Escaping Ganon's Tower 1", MapSelect_LoadGame, ENTR_GANON_SONOGO_0 },
    // "91: Ganon's Tower Aftermath 2" (Escaping Ganon's Tower 2)
    { "91: Escaping Ganon's Tower 2", MapSelect_LoadGame, ENTR_GANON_SONOGO_2 },
    // "92: Ganon's Tower Aftermath 3" (Escaping Ganon's Tower 3)
    { "92: Escaping Ganon's Tower 3", MapSelect_LoadGame, ENTR_GANON_SONOGO_4 },
    // "93: Ganon's Tower Aftermath 4" (Escaping Ganon's Tower 4)
    { "93: Escaping Ganon's Tower 4", MapSelect_LoadGame, ENTR_GANON_SONOGO_6 },
    // "94: Ganon's Basement Aftermath" (Escaping Ganon's Castle)
    { "94: Escaping Ganon's Castle", MapSelect_LoadGame, ENTR_GANONTIKA_SONOGO_0 },
    // "95: Gerudo Passage 1-2" (Thieves' Hideout 1)
    { "95: Thieves' Hideout 1", MapSelect_LoadGame, ENTR_GERUDOWAY_0 },
    // "96: Gerudo Passage 3-4 9-10" (Thieves' Hideout 2)
    { "96: Thieves' Hideout 2", MapSelect_LoadGame, ENTR_GERUDOWAY_2 },
    // "97: Gerudo Passage 5-6" (Thieves' Hideout 3)
    { "97: Thieves' Hideout 3", MapSelect_LoadGame, ENTR_GERUDOWAY_4 },
    // "98: Gerudo Passage 7-8" (Thieves' Hideout 4)
    { "98: Thieves' Hideout 4", MapSelect_LoadGame, ENTR_GERUDOWAY_6 },
    // "99: Gerudo Passage 11-12" (Thieves' Hideout 5)
    { "99: Thieves' Hideout 5", MapSelect_LoadGame, ENTR_GERUDOWAY_10 },
    // "100: Gerudo Passage 13" (Thieves' Hideout 6)
    { "100: Thieves' Hideout 6", MapSelect_LoadGame, ENTR_GERUDOWAY_12 },
    // "101: Hidden Dive Hole 0" (Grotto 0 - Gossip Stone & Chest)
    { "101: Grotto 0 - Gossip Stone & Chest", MapSelect_LoadGame, ENTR_KAKUSIANA_0 },
    // "102: Hidden Dive Hole 1" (Grotto 1 - Skulltula & Gold Skulltula)
    { "102: Grotto 1 - Skulltula & Gold Skulltula", MapSelect_LoadGame, ENTR_KAKUSIANA_1 },
    // "103: Hidden Dive Hole 2" (Grotto 2 - Business Scrub & Heart Piece)
    { "103: Grotto 2 - Business Scrub & Heart Piece", MapSelect_LoadGame, ENTR_KAKUSIANA_2 },
    // "104: Hidden Dive Hole 3" (Grotto 3 - Redeads)
    { "104: Grotto 3 - Redeads", MapSelect_LoadGame, ENTR_KAKUSIANA_3 },
    // "105: Hidden Dive Hole 4" (Grotto 4 - 3 Business Scrubs)
    { "105: Grotto 4 - Business Scrubs", MapSelect_LoadGame, ENTR_KAKUSIANA_4 },
    // "106: Hidden Dive Hole 5" (Grotto 5 - Gossip Stone, Skulltula, Cow)
    { "106: Grotto 5 - Gossip Stone, Skulltula, Cow", MapSelect_LoadGame, ENTR_KAKUSIANA_5 },
    // "107: Hidden Dive Hole 6" (Grotto 6 - Octorok)
    { "107: Grotto 6 - Octorok", MapSelect_LoadGame, ENTR_KAKUSIANA_6 },
    // "108: Hidden Dive Hole 7" (Grotto 7 - Business Scrub & Deku Nut Upgrade)
    { "108: Grotto 7 - Business Scrub & Deku Nut Upgrade", MapSelect_LoadGame, ENTR_KAKUSIANA_7 },
    // "109: Hidden Dive Hole 8" (Grotto 8 - 2 Wolfos)
    { "109: Grotto 8 - 2 Wolfos", MapSelect_LoadGame, ENTR_KAKUSIANA_8 },
    // "110: Hidden Dive Hole 9" (Grotto 9 - Bombable Walls)
    { "110: Grotto 9 - Bombable Walls", MapSelect_LoadGame, ENTR_KAKUSIANA_9 },
    // "111: Hidden Dive Hole 10" (Grotto 10 - 2 Business Scrubs)
    { "111: Grotto 10 - 2 Business Scrubs", MapSelect_LoadGame, ENTR_KAKUSIANA_10 },
    // "112: Hidden Dive Hole 11" (Grotto 11 - Tektite & Heart Piece)
    { "112: Grotto 11 - Tektite & Heart Piece", MapSelect_LoadGame, ENTR_KAKUSIANA_11 },
    // "113: Hidden Dive Hole 12" (Grotto 12 - Deku Stage)
    { "113: Grotto 12 - Deku Stage", MapSelect_LoadGame, ENTR_KAKUSIANA_12 },
    // "114: Hidden Dive Hole 13" (Grotto 13 - Rupees & Cow)
    { "114: Grotto 13 - Rupees & Cow", MapSelect_LoadGame, ENTR_KAKUSIANA_13 },
    // "115: Hyrule Cutscenes" (Cutscene Map)
    { "115: TEST - Cutscene Map", MapSelect_LoadGame, ENTR_HIRAL_DEMO_0 },
    // "116: Special Room (Treasure Chest Warp)" (Ganondorf Test Room)
    { "116: TEST - Ganondorf Test Room", MapSelect_LoadGame, ENTR_BESITU_0 },
    // "117: Sasaki Test" (Sasa Test)
    { "117: TEST - Sasa Test", MapSelect_LoadGame, ENTR_SASATEST_0 },
    // "118: Test Map" (Jungle Gym)
    { "118: TEST - Jungle Gym", MapSelect_LoadGame, ENTR_TEST01_0 },
    // "119: Test Room" (Treasure Chest Room)
    { "119: TEST - Treasure Chest Room", MapSelect_LoadGame, ENTR_TESTROOM_0 },
    // "120: Stalfos Miniboss Room" (Stalfos Miniboss Room)
    { "120: TEST - Stalfos Miniboss Room", MapSelect_LoadGame, ENTR_SYOTES_0 },
    // "121: Boss Stalfos Room" (Stalfos Boss Room)
    { "121: TEST - Stalfos Boss Room", MapSelect_LoadGame, ENTR_SYOTES2_0 },
    // "122: Stal" (Sutaru)
    { "122: TEST - Sutaru", MapSelect_LoadGame, ENTR_SUTARU_0 },
    // "123: Test Area" (Shooting Gallery)
    { "123: TEST - Shooting Gallery", MapSelect_LoadGame, ENTR_TEST_SYATEKIJYOU_0 },
    // "124: Depth Test" (Depth Test)
    { "124: TEST - Depth Test", MapSelect_LoadGame, ENTR_DEPTH_TEST_0 },
    // "125: Hyrule Garden Game 2" (Early Hyrule Garden Game)
    { "125: TEST - Early Hyrule Garden Game", MapSelect_LoadGame, ENTR_HAIRAL_NIWA2_0 },
    // "title" (Title Screen)
    { "title", (void*)MapSelect_LoadGame, 0 },
};
