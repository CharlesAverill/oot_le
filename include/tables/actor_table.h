...
/* 0x01D7 */ DEFINE_ACTOR(En_Tido, ACTOR_EN_TIDO, ACTOROVL_ALLOC_NORMAL, "En_Tido")
/* 0x01D8 */ DEFINE_ACTOR(Obj_KokiriSword, ACTOR_OBJ_KOKIRISWORD, ACTOROVL_ALLOC_NORMAL, "Obj_KokiriSword")
/* 0x01D9 */ DEFINE_ACTOR(Obj_BeanPlatform, ACTOR_OBJ_BEANPLATFORM, ACTOROVL_ALLOC_NORMAL, "Obj_BeanPlatform")
/* 0x01DA */ DEFINE_ACTOR(En_Lynel, ACTOR_EN_LYNEL, ACTOROVL_ALLOC_NORMAL, "En_Lynel")
/* 0x01DB */ DEFINE_ACTOR(En_Greeble, ACTOR_EN_GREEBLE, ACTOROVL_ALLOC_NORMAL, "En_Greeble")
/* 0x01DC */ DEFINE_ACTOR(En_Zl5, ACTOR_EN_ZL5, ACTOROVL_ALLOC_NORMAL, "En_Zl5")
