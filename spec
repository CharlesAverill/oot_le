...
beginseg
    name "learning01_room_1"
    romalign 0x1000
    include "build/assets/scenes/overworld/learning01/learning01_room_1_main.o"
    include "build/assets/scenes/overworld/learning01/learning01_room_1_model_info.o"
...
beginseg
    ...
    include "build/assets/scenes/overworld/newmarket/newmarket_scene_tex.o"
    number 2
endseg
...
beginseg
    name "newmarket_room_1"
    romalign 0x1000
    include "build/assets/scenes/overworld/newmarket/newmarket_room_1_main.o"
    include "build/assets/scenes/overworld/newmarket/newmarket_room_1_model_info.o"
